...
if($db_type=="mysql"){
    ...
    $stmt = $conn->prepare("INSERT INTO speedtest_users (ip,ua,lang,dl,ul,ping,jitter,log,localIp) VALUES (?,?,?,?,?,?,?,?,?)") or die("2");
    $stmt->bind_param("sssssssss",$ip,$ua,$lang,$dl,$ul,$ping,$jitter,$log,$localIp) or die("3");
